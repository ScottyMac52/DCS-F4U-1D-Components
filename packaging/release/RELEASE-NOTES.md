...
- secondary supercharger axis with middle/outer axes and rockers intentionally unbound;
- legacy Saitek alias consolidation and device-isolation validation;
- a photo-backed dual-quadrant OpenKneeboard reference page;
- GUID-qualified WINCTRL CarrierAce PTO2 profile preserving all 25 assignments
  from Scott's current DCS export;
- native flaps, approach-light, airbrake, drop-tank-lock, release-selector,
  emergency-release, and parking-brake commands;
- native landing-gear UP/DOWN commands;
